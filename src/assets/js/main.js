...
(function ($) {
  ...
  /* Select */
  $("#countryOption,#cityOption,#skillsOption").select2({
...
$(".submitBTN").click(function () {
  $("#showOTP").hide();
  $("#successVerification2").show();
  $(".actbtn").show();
});

$(".finalBtn").click(function () {
  $(".hideinfo").hide();
  $("#successVerification").show();
  ...
  function changeLayout(e) {
    ...
    if (this.dataset.layout === "light") {
      $('ul.l_sidebar li a').removeClass('active');
      ...
      $('ul.l_navbar li a').removeClass('active');
      $(this).addClass("active");
