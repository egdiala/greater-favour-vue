        ...
        <div class="row">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div
                v-else-if="!isLoading && interests.length < 1"
                class="col-12"
              >
                <div
                ...
                >
                  <div class="card-body">
                    ...
                    <br />
                    <h3>Oops</h3>
                    <h6>No Interest here...</h6>
                  </div>
                </div>
              </div>
              <div
                v-else-if="!isLoading && interests.length > 0"
                class="col-12"
              >
                <div
                ...
                >
                  <div class="table-responsive">
                    <table class="table mb-0 table-borderless border-0">
                      ...
                      <tbody>
                        <tr v-for="(interest, f) in interests" :key="f">
                          <td>
...
export default {
  ...
  methods: {
    getInterests(num) {
      ...
      let url = "/v1/office/adjudicate/account/interest";
      url =
        num != undefined && num != ""
